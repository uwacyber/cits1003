...
This unit requires software that the University IT team can't install on the lab machines and so you will need to use your own laptop. This installation instructions will be provided in Lab 1.

If you do not have a laptop, the Student Success and Wellbeing IT Equipment Scheme offers provide two options: you can request either a loan or permanent laptop. For students with more than two semesters left, I would encourage them to apply for permanent ownership rather than a loan. Application to the Scheme includes consideration of financial hardship, personal circumstance, wellbeing and family commitments.
...
{% hint style="info" %}
It is essential that you reserve at least 20 GiB of disk space to store the lab files (e.g., docker images). You can free disk space by removing each completed lab files later.
{% endhint %}
