...
Change directory into `/opt/malware/malware_sample2`, unzip `malware2.zip` and run yara using the rules file against the malware. It should identify it with a name. Once you have found out the name of the malware, investigate the web to find out the following about the malware:
