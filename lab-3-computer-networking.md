...
![](.gitbook/assets/network1%20%281%29.jpg)
...
On the docker container, there are actually 4 network interfaces. Two we have mentioned above, find out what the other 2 are 

**Flag: Enter the name of the interface that starts with a 't'**
